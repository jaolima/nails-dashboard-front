...
const Edit_product = (props, { afterPaste, onBlur, onChange }) => {
  ...
  useEffect(() => {
    api
      ...
      .then((res) => {
        const data = res.data;
        const { color, size, qtd, name, price, alias_color, description } =
          data;
        console.log(data);
        setColor(color);
        setSize(size);
                      ...
                      <FormGroup className="form-group mb-3 row">
                        ...
                        <div className="col-xl-8 col-sm-7">
                          <Input
                            value={aliasColor}
                            onChange={(event) =>
                              setAliasColor(event.target.value)
                            }
                            className="form-control"
                            name="alias_color"
                            id="alias_color"
